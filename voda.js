...
function setup() {
    ...
    let yaoYin2A = new c2.LineField(new c2.Line(width*0.25, height*0.25, width*0.4, height*0.25), 0.4);
    world.addForce(yaoYin2A);
    yaoYin2A.range(0, 300);

    let yaoYin2B = new c2.LineField(new c2.Line(width*0.6, height*0.25, width*0.75, height*0.25), 0.4);
